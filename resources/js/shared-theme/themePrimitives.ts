...
const lightBaseShadow =
    'hsla(220, 30%, 5%, 0.07) 0px 4px 16px 0px, hsla(220, 25%, 10%, 0.07) 0px 8px 16px -5px';
const darkBaseShadow =
...
export const colorSchemes = {
    ...
    dark: {
        palette: {
            ...
            baseShadow: darkBaseShadow,
        },
    },
} as const;

// Keep helper export in case future CRUD pages use palette generation directly.
...
// @ts-expect-error palette CSS variable shadow token is injected at runtime
